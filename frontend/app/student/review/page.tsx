...
export default function QuickReviewPage() {
  ...
  return <main className="min-h-screen bg-muted/30">
    <div className="mx-auto max-w-5xl px-5 py-8 md:px-8 md:py-10">
      ...
      <header className="mb-8"><p className="text-xs font-semibold uppercase tracking-[.18em] text-primary">Repaso rápido</p><h1 className="mt-2 text-3xl font-bold tracking-tight">Refresh your vocabulary</h1><p className="mt-2 text-muted-foreground">Choose a lesson. We’ll take care of the words.</p></header>

      {!selected ? <section>
        <div className="mb-4 flex items-center gap-2"><Layers3 className="size-5 text-primary" /><h2 className="font-semibold">Escoge una lección</h2></div>
